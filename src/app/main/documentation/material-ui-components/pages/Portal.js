  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        :::warning Please refer to the <a href="/base/react-portal/">Portal</a> component page in
        the MUI Base docs for demos and details on usage.
      </Typography>
      <Typography className="mb-40" component="div">
        Portal is a part of the standalone <a href="/base/getting-started/overview/">MUI Base</a>{' '}
